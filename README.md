...
1. [**Amazon Machine Image**](#14-amazon-machine-image): We also maintain AMI [`ami-0e7d25297242fda33`](https://console.aws.amazon.com/ec2/v2/home?region=us-east-1#LaunchInstanceWizard:ami=ami-0e7d25297242fda33) that has the FlyBrainLab fully installed. It is helpful in case you do not have a machine with NVIDIA GPU handy, but still want to try out the full installation.
